...
## Install
    ...
    git clone https://github.com/Astar-IT/marz-manager.git
    cd marz-manager
    yarn install
...
| Name          | Description                                                                          |
| ------------- | ------------------------------------------------------------------------------------ |
| VITE_BASE_API | The api url of the deployed backend ([Marzban](https://github.com/Astar-IT/Marzban-astar-it)) |
